...
if args.norelation:
    fileObject.write('no relation' + str(auc) + args.mode + ' ' + args.method + ' ' + args.mimethod + ' ' + str(args.lr) + ' ' + str(args.milr) + ' ' + str(args.hidden_size) + ' ' + str(args.batch_size))
elif args.noglove:
    fileObject.write('no glove' + str(auc) + args.mode + ' ' + args.method + ' ' + args.mimethod + ' ' + str(args.milr) + ' ' + str(args.hidden_size) + ' ' + str(args.batch_size))
elif args.nonode:
    fileObject.write('no node' + str(auc) + args.mode + ' ' + args.method + ' ' + args.mimethod + ' ' + str(args.milr) + ' ' + str(args.hidden_size) + ' ' + str(args.batch_size))
else:
    fileObject.write(str(auc) + args.mode + ' ' + args.method + ' ' + args.mimethod + ' ' + str(args.milr) + ' ' + str(args.hidden_size)+ ' ' + str(args.batch_size))
fileObject.write('\n')
fileObject.close()
